; p-i2-c
; Programa para control de Pata izda nº2 de Melanie. servos y entrada analógica (Sensor presión)
...
;Definición de macros
	...
	#define	Offset1	d'70'	;Offset Servo nº1
	#define	Offset2	d'60'	;Offset Servo nº2
	#define	Offset3	d'60'	;Offset Servo nº3
...
; ---------------------------------------------------------------------------------------
	...
	movwf	Posic1		
	movlw	d'168'			;Establece valor inicial de posicion
	movwf	Posic2		
