; p-i1-c
; Programa para control de Pata izda nº1 de Melanie. servos y entrada analógica (Sensor presión)
...
;Definición de macros
	...
	#define	DirNodo		b'01110110'	;Dirección I2C de este nodo
	...
	#define	Offset2	d'38'	;Offset Servo nº2
...
; ---------------------------------------------------------------------------------------
	...
	movwf	Posic1		
	movlw	d'170'			;Establece valor inicial de posicion
	movwf	Posic2		
