; p-i3-c
; Programa para control de Pata izda nº3 de Melanie. servos y entrada analógica (Sensor presión)
...
; ---------------------------------------------------------------------------------------
	...
	movwf	Posic1		
	movlw	d'172'			;Establece valor inicial de posicion
	movwf	Posic2		
	movlw	d'0'			;Establece valor inicial de posicion
	movwf	Posic3		
	return
...
; ---------------------------------------------------------------------------------------
	...
	movlw	d'8'		; Articulación 2 ha de moverse 32 grados (8*4=32)
	movwf	Temp3		;
	movlw	d'004'
	movwf	Pausa

Cic1	incf	Posic3,F	;Se acerca 1 grado más a su destino
	movlw	d'4'		; Articulación 3 ha de moverse 1 grado por cada 6 de...
	movwf	Temp2		; ... Articulación 2.
Cic2	decf	Posic2,F	;Se acerca 1 grado más a su destino
	call	HacerTiempo 	;pausa
