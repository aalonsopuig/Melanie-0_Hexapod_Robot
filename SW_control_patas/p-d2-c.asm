; p-d2-c
; Programa para control de Pata dcha nº2 de Melanie. servos y entrada analógica (Sensor presión)
...
;Definición de macros
	...
	#define	DirNodo		b'01110010'	;Dirección I2C de este nodo

	;Definiciones servos
	#define	Servo1	PORTA,1	;RA1 - Servo nº1
	#define	Servo2	PORTA,2	;RA2 - Servo nº2
	#define	Servo3	PORTA,3	;RA3 - Servo nº3
	#define	Offset1	d'58'	;Offset Servo nº1
	#define	Offset2	d'162'	;Offset Servo nº2
...
; ---------------------------------------------------------------------------------------
	...
	movwf	Posic1		
	movlw	d'13'			;Establece valor inicial de posicion
	movwf	Posic2		
	movlw	d'180'			;Establece valor inicial de posicion
	movwf	Posic3		
	return
